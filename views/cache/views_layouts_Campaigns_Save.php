...
<form name="saveCampain" id="saveCampain" class="">
	<div class="row g-3">
		...
		<div class="col-sm-12">
			...
			<input type="date" class="form-control" name="opening" id="opening" value="<?php echo $campaign['opening'] ?? '' ?>"  pattern="\d{4}-\d{2}-\d{2}">
		</div>
		<div class="col-sm-12">
			<label for="closing" class="form-label">End Date <span class="text-danger">*</span></label>
			<input type="date" class="form-control" name="closing" id="closing" value="<?php echo $campaign['closing'] ?? '' ?>">
		</div>
		<div class="col-sm-12">

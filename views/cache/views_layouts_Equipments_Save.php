...
<nav aria-label="breadcrumb" class="mt-2">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a class="display-6" style="text-decoration: none;" href="<?php echo route('/equipments') ?>">Equipments</a></li>
...
<form name="saveEquipment" class="">
	<div class="row g-3">
		<div class="col-sm-6">
			...
			<input type="hidden" name="user_uid" class="form-control" id="user_uid" value="<?php echo $equipments['user_uid']; ?>">
		...
		<div class="col-sm-6">
			...
			<input type="text" class="form-control" name="equipments_uid" id="equipments_uid" value="<?php echo $equipments['equipments_uid']; ?>" readonly="readonly">
		</div>

		<div class="col-sm-6">
			<label for="name" class="form-label">Equipment Name <span class="text-danger">*</span></label>
			<input type="text"  class="form-control" name="name" id="name" value="<?php echo $equipments['name']; ?>">
		</div>

		<div class="col-sm-6">
			<label for="brand" class="form-label">Number of trees <span class="text-danger">*</span></label>
			<input type="text" class="form-control" name="brand" id="brand" value="<?php echo $equipments['brand']; ?>">
		</div>

		<div class="col-sm-6">
			<label for="model" class="form-label">Model</label>
			<input type="text" class="form-control" name="model" id="model" value="<?php echo $equipments['model']; ?>">
		</div>
		<div class="col-sm-6">
			<label for="province" class="form-label">Status</label>
			<select class="form-select form-select-lg select2" id="status" name="status">
				<option value="Operational" <?php echo $equipments['status' == 'Operational' ? 'selected' : ''] ?>>Operational</option>
				<option value="Non operational" <?php echo $equipments['status' == 'Non operational' ? 'selected' : ''] ?>>Non operational</option>
			</select>
		</div>
	...
	$(document).ready(function() {
		$("#btnSaveEquipment").click(function(e) {
			try{
				...
				$.ajax({
					url: "<?php echo route('/equipments/save/'.$equipments['id']) ?>",
					method: "POST",
					dataType: "JSON",
					data: {

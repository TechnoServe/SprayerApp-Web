...
<nav aria-label="breadcrumb" class="mt-2">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a class="display-6" style="text-decoration: none;" href="<?php echo route('/faqs') ?>">Faqs</a></li>
...
<form name="saveFaq" id="saveFaq" class="">
	<div class="row g-3">
		...
		<div class="col-sm-12">
			...
			<input type="text" class="form-control" name="title" id="title" value="<?php echo $faq['title'] ?? '' ?>">
		</div>
		<div class="col-sm-12">
			<label for="description" class="form-label">Description <span class="text-danger">*</span></label>
			<textarea class="form-control" name="description" id="description"><?php echo $faq['description'] ?? '' ?></textarea>
		</div>
		<div class="col-sm-12">

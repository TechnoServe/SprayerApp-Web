...
<nav aria-label="breadcrumb" class="mt-2">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a class="display-6" style="text-decoration: none;" href="<?php echo route('/incomes') ?>">Expenses or Incomes</a></li>
...
<form name="saveIncome" id="saveIncome" class="">
	<div class="row g-3">
		<div class="col-sm-6">
			...
			<input type="hidden" name="user_uid" class="form-control" id="user_uid" value="<?php echo $incomes['user_uid']; ?>">
		...
		<div class="col-sm-6">
			...
			<input type="text" class="form-control" name="expenses_income_uid" id="expenses_income_uid" value="<?php echo $incomes['expenses_income_uid']; ?>" readonly="readonly">
		</div>
		...
		<div class="col-sm-6">
			...
			<select class="form-select form-select-lg select2" id="category" name="category">
				...
				<option value="<?php echo $category ?>" <?php echo $incomes['category'] == $category ? 'selected' : '' ?>><?php echo $category ?></option>
				<?php endforeach; ?>
			</select>
		</div>
		...
		<div class="col-sm-6">
			...
			<select class="form-select form-select-lg select2" id="expenses_income_type" name="expenses_income_type">
				...
				<option value="<?php echo $type ?>" <?php echo $incomes['expenses_income_type'] == $type ? 'selected' : '' ?>><?php echo $type ?></option>
				<?php endforeach; ?>
			</select>
		</div>
		...
		<div class="col-sm-6">
			...
			<select class="form-select form-select-lg select2" id="expenses_income_payment_type" name="expenses_income_payment_type">
				...
				<option value="<?php echo $payment ?>" <?php echo $incomes['expenses_income_payment_type'] == $payment ? 'selected' : '' ?>><?php echo $payment ?></option>
				<?php endforeach; ?>
			</select>
		</div>
		...
		<div class="col-sm-6">
			...
			<input type="number" min="0" step="any" class="form-control" name="price" id="price" value="<?php echo $incomes['price']; ?>">
		</div>

		<div class="col-sm">
			<label for="description" class="form-label">Deescription</label>
			<textarea class="form-control" name="description" id="description"><?php echo $incomes['description']; ?></textarea>
		</div>
	...
	$(document).ready(function() {
		$("#btnSaveIncome").click(function(e) {
			try{
				...
				$.ajax({
					url: "<?php echo route('/incomes/save/'.$incomes['id']) ?>",
					method: "POST",
					dataType: "JSON",
					data: formData,

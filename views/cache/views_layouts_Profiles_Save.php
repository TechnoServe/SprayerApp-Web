...
<nav aria-label="breadcrumb" class="mt-2">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a class="display-6" style="text-decoration: none;" href="<?php echo route('/profiles') ?>">Profiles</a></li>
...
<form name="saveProfile" id="saveProfile" class="">
	<div class="row g-3">
		<div class="col-sm-12">
			...
			<input type="text" class="form-control" id="name" value="<?php echo $profile['name'] ?? 'N/A'; ?>">
		</div>
		...
		<div class="col-12">
			...
			<select class="form-select form-select-lg select2" id="visibility">
				...
				<option value="district" <?php echo $profile['visibility'] == 'district' ? 'selected' : ''; ?>>District</option>
				<option value="province" <?php echo $profile['visibility'] == 'province' ? 'selected' : ''; ?>>Province</option>
				<option value="national" <?php echo $profile['visibility'] == 'national' ? 'selected' : ''; ?>>National</option>
			</select>
		</div>
		<div class="col-12">
			<div class="mb-3 form-check form-switch">
				<input class="form-check-input input-lg" type="checkbox" role="switch" id="webAccess" <?php echo $profile['web_access'] == 1 ? 'checked' : ''; ?>>
				<label class="form-check-label" for="webAccess">Web access</label>
			</div>
			<div class="mb-3 form-check form-switch">
				<input class="form-check-input" type="checkbox" role="switch" id="mobileAccess" <?php echo $profile['mobile_acess'] == 1 ? 'checked' : ''; ?>>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSaveProfile").click(function(e) {
			...
			$.ajax({
				url: "<?php echo route('/profiles/save/'.$profile['id']) ?>",
				method: "POST",
				dataType: "JSON",
				data: {
					name: name,
